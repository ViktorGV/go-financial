...
[![unit-tests status](https://github.com/VIktorGV/go-financial/workflows/unit-tests/badge.svg?branch=master "unit-tests")]("https://github.com/VIktorGV/go-financial/workflows/unit-tests/badge.svg?branch=master")  [![Go Report Card](https://goreportcard.com/badge/github.com/VIktorGV/go-financial)](https://goreportcard.com/report/github.com/VIktorGV/go-financial)  [![codecov](https://codecov.io/gh/VIktorGV/go-financial/branch/master/graph/badge.svg)](https://codecov.io/gh/VIktorGV/go-financial)  [![GoDoc](https://godoc.org/github.com/VIktorGV/go-financial?status.svg)](https://godoc.org/github.com/VIktorGV/go-financial) [![Release](https://img.shields.io/github/release/VIktorGV/go-financial.svg?style=flat-square)](https://github.com/VIktorGV/go-financial/releases)  [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
...
While the numpy-financial package contains a set of elementary financial functions, this pkg also contains some helper functions on top of it. Their usage and description can be found below:  
 ...
 Detailed documentation is available at [godoc](https://godoc.org/github.com/VIktorGV/go-financial).
...
import (
	...
	financial "github.com/VIktorGV/go-financial"
